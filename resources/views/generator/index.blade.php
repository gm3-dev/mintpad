<x-app-layout>
    <div class="text-center mb-12">
        <h2 class="text-3xl text-center mb-1 font-semibold dark:text-gray-200">{{ __('NFT generator') }}</h2>
        <p class="text-mintpad-300 dark:text-gray-400 text-center text-lg">{{ __('Upload all your images here, edit the rarities, and generate your collection.') }}</p>
    </div>

    <div v-if="!generator.layers.length" class="mb-10">
        <h3 class="text-2xl mb-4 mt-6 dark:text-gray-200">{{ __('Add your collection input') }}</h3>
