        ...
        <div class="relative mb-12 px-2">
            ...
            @else
                ...
                @foreach ($invoices as $invoice)
                    <div class="px-6 py-1 mb-4 text-mintpad-500 dark:text-white rounded-2xl border border-mintpad-200 dark:border-gray-600 bg-primary-100 dark:bg-mintpad-700 flex flex-row text-left items-center text-sm">
