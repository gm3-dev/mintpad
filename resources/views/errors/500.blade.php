    ...
    <div class="bg-white overflow-hidden text-center">
        ...
        <div class="bg-white">
            ...
            <div class="text-center">
                <h2 class="text-3xl text-center mb-1 font-semibold dark:text-gray-200">{{ __('Something went wrong') }}</h2>
                <p class="text-mintpad-300 text-center text-lg">{{ __('Please try again, or contact support.') }}</p>
            </div>
        </div>
    </div>
</x-minimal-layout>
