<div v-if="messageBag" class="fixed w-1/3 bottom-2 inset-x-0 mx-auto">
    <div v-for="message in messageBag" class="px-6 py-2 mb-2 rounded-md bg-white dark:bg-mintpad-700 border dark:border-0 border-primary-200" role="alert">
        <div class="w-full">
...
@if ($message = Session::get('success'))
    <div class="flex fixed w-1/3 bottom-2 inset-x-0 mx-auto px-6 py-2 mb-2 rounded-md bg-white dark:bg-mintpad-700 border dark:border-0 border-primary-200" role="alert">
