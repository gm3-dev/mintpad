...
<div class="w-full h-96 bg-black/[.35] dark:bg-mintpad-800/[.35] bg-top bg-cover bg-blend-multiply" v-bind:class="{'sm:mt-14': editMode}" v-bind:style="[collection.background ? {backgroundImage: 'url(' + collection.background + ')'} : {}]">
    <div class="relative max-w-7xl mx-auto px-6 pb-4 h-full flex gap-4 items-end">
        <a v-if="editMode" href="#" @click.prevent="addLogo" class="absolute top-4 left-6">
            ...
            <div v-else>
                <x-default-button href="#" class="!px-3"><i class="fa-solid fa-plus mr-2 text-lg align-middle"></i> <span class="align-middle">Add logo</span></x-default-button>
            </div>
        </a>
        ...
        <x-box class="sm:col-span-2">
            ...
            <x-slot name="content">
                ...
                <div v-if="!editMode" class="flex gap-2">
                    <x-input type="number" v-model="mintAmount" min="1" v-bind:max="maxMintAmount" width="w-28" class="!mb-0" />                 
                ...
                <div v-else class="flex gap-2">
                    <x-input type="number" value="1" width="w-28" class="!mb-0" />   
        ...
        <x-box>
            ...
            <x-slot name="content">
                <div class="grid grid-cols-2 gap-1">
                    ...
                    <p>Collection Size</p><p class="font-medium !text-primary-600 mint-text-primary" v-html="collection.totalSupply"></p>
                    <p>Creator Royalties</p><p class="font-medium !text-primary-600 mint-text-primary" v-html="collection.royalties"></p>
                    <p>Type</p><p class="font-medium !text-primary-600 mint-text-primary">ERC-721</p>
                    <p>Blockchain</p><p class="font-medium !text-primary-600 mint-text-primary" v-html="collection.chainName"></p>
                </div>
            </x-slot>
        </x-box>
