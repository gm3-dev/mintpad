...
@endif
    @if ($addon && $position == 'left')
        <span class="inline-flex mb-4 rounded-l-md font-regular text-sm text-mintpad-700 dark:text-white bg-primary-100 border border-r-0 border-primary-200 dark:border-gray-600">
            <span class="inline-block px-3 my-2 border-r border-primary-200 dark:border-gray-600">{{ $addon }}</span>
        </span>
    @endif
    ...
    @if ($addon && $position == 'right')
        <span class="inline-flex mb-4 rounded-r-md font-regular text-sm text-mintpad-700 dark:text-white bg-primary-100 border border-l-0 border-primary-200 dark:border-gray-600">
            <span class="inline-block px-3 my-2 border-l border-primary-200 dark:border-gray-600">{{ $addon }}</span>
        </span>
    @endif
