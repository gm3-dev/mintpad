<x-editor-layout>
    ...
    <div class="fixed z-40 left-0 top-0 p-2 w-full bg-white border-b border-mintpad-200">
        <div class="max-w-7xl mx-auto px-6 flex">
            ...
            <x-blue-button href="#" class="align-middle ml-4 !rounded-full !px-5 !py-1 !text-xs !leading-6" @click.prevent="openYouTubeModal('https://www.youtube.com/embed/pNR-FvMcvGo')"><i class="fas fa-play mr-1 text-md align-middle"></i> <span class="align-middle text-xs">{{ __('Watch tutorial') }}</span></x-blue-button>
        </div>
    </div>
