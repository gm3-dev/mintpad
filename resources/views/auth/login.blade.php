    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" placeholder="{{ __('Enter your email') }}" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="password" class="block mt-1 w-full" type="password" name="password" placeholder="{{ __('Enter your password') }}" required autocomplete="current-password" />
            </div>
