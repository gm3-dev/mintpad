<x-editor-layout>
    ...
    <div id="custom-style-container" class="mt-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div class="lg:col-span-2 text-center p-3">
            <a href="#" @click.prevent="addMintLogo" class="inline-block">
