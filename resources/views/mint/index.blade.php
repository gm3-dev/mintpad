<x-mint-layout>
    ...
    <div id="custom-style-container" class="mt-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div v-show="tab == 1" class="lg:col-span-2 bg-white rounded-xl p-8 tinymce-html" v-html="collection.about"></div>
        <div v-show="tab == 2" class="lg:col-span-2 bg-white rounded-xl p-8 tinymce-html" v-html="collection.roadmap"></div>
        <div v-show="tab == 3" class="lg:col-span-2 bg-white rounded-xl p-8 tinymce-html" v-html="collection.team"></div>
    </div>
