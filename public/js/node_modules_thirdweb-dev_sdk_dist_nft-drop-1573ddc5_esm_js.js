"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_nft-drop-1573ddc5_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/nft-drop-1573ddc5.esm.js":
/*!**********************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/nft-drop-1573ddc5.esm.js ***!
  \**********************************************************************/
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ethers */ "./node_modules/@ethersproject/strings/lib.esm/utf8.js");
...
class NFTDrop extends _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.aF {
  /**
   * @internal
   */
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.ai(this.contractWrapper, NFTDrop.contractRoles);
  ...
  async getAllUnclaimed(queryParams) {
    const start = ethers__WEBPACK_IMPORTED_MODULE_45__.BigNumber.from((queryParams === null || queryParams === void 0 ? void 0 : queryParams.start) || 0).toNumber();
    const count = ethers__WEBPACK_IMPORTED_MODULE_45__.BigNumber.from((queryParams === null || queryParams === void 0 ? void 0 : queryParams.count) || _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.a_).toNumber();
    const firstTokenId = ethers__WEBPACK_IMPORTED_MODULE_45__.BigNumber.from(Math.max((await this.contractWrapper.readContract.nextTokenIdToClaim()).toNumber(), start));
  ...
  async createBatch(metadatas, options) {
    ...
    const batch = await (0,_paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.cB)(metadatas, this.storage, startFileNumber.toNumber(), options); // ensure baseUri is the same for the entire batch
    ...
    const receipt = await this.contractWrapper.sendTransaction("lazyMint", [batch.length, baseUri.endsWith("/") ? baseUri : `${baseUri}/`, ethers__WEBPACK_IMPORTED_MODULE_47__.toUtf8Bytes("")]);
  ...
  async prepareClaim(quantity, checkERC20Allowance) {
    return (0,_paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.cC)(quantity, await this.claimConditions.getActive(), async () => (await this.metadata.get()).merkle, 0, this.contractWrapper, this.storage, checkERC20Allowance);
  }
  /**
   * @internal
   */
...
(0,_defineProperty_fe02f37c_esm_js__WEBPACK_IMPORTED_MODULE_44__._)(NFTDrop, "contractRoles", ["admin", "minter", "transfer"]);
