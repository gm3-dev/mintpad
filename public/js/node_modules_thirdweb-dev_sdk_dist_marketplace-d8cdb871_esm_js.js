"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_marketplace-d8cdb871_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/marketplace-d8cdb871.esm.js":
/*!*************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/marketplace-d8cdb871.esm.js ***!
  \*************************************************************************/
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ethers */ "./node_modules/@ethersproject/bignumber/lib.esm/bignumber.js");
/* harmony import */ var tiny_invariant__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! tiny-invariant */ "./node_modules/tiny-invariant/dist/tiny-invariant.esm.js");
...
class Marketplace {
  ...
  constructor(network, address, storage) {
    ...
    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(this, "contractWrapper", void 0);

    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(this, "storage", void 0);
    ...
    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(this, "direct", void 0);

    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(this, "auction", void 0);

    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(this, "_chainId", void 0);

    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(this, "getAll", this.getAllListings);

    this._chainId = chainId;
    this.abi = abi;
    this.contractWrapper = contractWrapper;
    this.storage = storage;
    this.metadata = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.ag(this.contractWrapper, _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.co, this.storage);
    this.roles = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.ah(this.contractWrapper, Marketplace.contractRoles);
    ...
    this.direct = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.aN(this.contractWrapper, this.storage);
    this.auction = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.aO(this.contractWrapper, this.storage);
  ...
  async getListing(listingId) {
    ...
    if (listing.assetContract === ethers__WEBPACK_IMPORTED_MODULE_48__.AddressZero) {
      throw new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.bf(this.getAddress(), listingId.toString());
    }

    switch (listing.listingType) {
      case _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.aZ.Auction:
        {
          return await this.auction.mapListing(listing);
        }

      case _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.aZ.Direct:
        {
  ...
  async getActiveListings(filter) {
    ...
    const now = ethers__WEBPACK_IMPORTED_MODULE_49__.BigNumber.from(Math.floor(Date.now() / 1000));
    return filtered.filter(l => {
      return l.type === _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.aZ.Auction && ethers__WEBPACK_IMPORTED_MODULE_49__.BigNumber.from(l.endTimeInEpochSeconds).gt(now) && ethers__WEBPACK_IMPORTED_MODULE_49__.BigNumber.from(l.startTimeInEpochSeconds).lte(now) || l.type === _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.aZ.Direct && l.quantity > 0;
    });
  }
  /**
  ...
  async isRestrictedToListerRoleOnly() {
    const anyoneCanList = await this.contractWrapper.readContract.hasRole((0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.br)("lister"), ethers__WEBPACK_IMPORTED_MODULE_48__.AddressZero);
  ...
  async getOffers(listingId) {
    ...
    const offers = await Promise.all(listingEvents.map(async e => {
      const offer = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cp)(this.contractWrapper.getProvider(), ethers__WEBPACK_IMPORTED_MODULE_49__.BigNumber.from(listingId), {
  ...
  async buyoutListing(listingId, quantityDesired, receiver) {
    ...
    switch (listing.listingType) {
      case _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.aZ.Direct:
        {
          (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_50__["default"])(quantityDesired !== undefined, "quantityDesired is required when buying out a direct listing");
  ...
  async setBidBufferBps(bufferBps) {
    ...
    await this.contractWrapper.sendTransaction("setAuctionBuffers", [timeBuffer, ethers__WEBPACK_IMPORTED_MODULE_49__.BigNumber.from(bufferBps)]);
  }
  /**
  ...
  async setTimeBufferInSeconds(bufferInSeconds) {
    ...
    await this.contractWrapper.sendTransaction("setAuctionBuffers", [ethers__WEBPACK_IMPORTED_MODULE_49__.BigNumber.from(bufferInSeconds), bidBuffer]);
  }
  /**
  ...
  async allowListingFromSpecificAssetOnly(contractAddress) {
    ...
    if (members.includes(ethers__WEBPACK_IMPORTED_MODULE_48__.AddressZero)) {
      encoded.push(this.encoder.encode("revokeRole", [(0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.br)("asset"), ethers__WEBPACK_IMPORTED_MODULE_48__.AddressZero]));
    }

    encoded.push(this.encoder.encode("grantRole", [(0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.br)("asset"), contractAddress]));
  ...
  async allowListingFromAnyAsset() {
    ...
    for (const addr in members) {
      encoded.push(this.encoder.encode("revokeRole", [(0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.br)("asset"), addr]));
    }

    encoded.push(this.encoder.encode("grantRole", [(0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.br)("asset"), ethers__WEBPACK_IMPORTED_MODULE_48__.AddressZero]));
    await this.contractWrapper.multiCall(encoded);
  }
  /** ******************************
   * PRIVATE FUNCTIONS
  ...
  async getAllListingsNoFilter(filterInvalidListings) {
    const listings = await Promise.all(Array.from(Array((await this.contractWrapper.readContract.totalListings()).toNumber()).keys()).map(async i => {
      ...
      try {
        ...
        if (err instanceof _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.bf) {
          return undefined;
        } else {
      ...
      if (listing.type === _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.aZ.Auction) {
        return listing;
      }
  ...
  applyFilter(listings, filter) {
    ...
    const start = ethers__WEBPACK_IMPORTED_MODULE_49__.BigNumber.from((filter === null || filter === void 0 ? void 0 : filter.start) || 0).toNumber();
    const count = ethers__WEBPACK_IMPORTED_MODULE_49__.BigNumber.from((filter === null || filter === void 0 ? void 0 : filter.count) || _QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__.D).toNumber();
...
(0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(Marketplace, "contractRoles", ["admin", "lister", "asset"]);
