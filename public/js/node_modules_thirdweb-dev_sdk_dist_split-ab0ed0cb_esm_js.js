"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_split-ab0ed0cb_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/split-ab0ed0cb.esm.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/split-ab0ed0cb.esm.js ***!
  \*******************************************************************/
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ethers */ "./node_modules/@ethersproject/contracts/lib.esm/index.js");
...
class Split {
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.ah(this.contractWrapper, _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.cJ, this.storage);
    this.roles = new _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.ai(this.contractWrapper, Split.contractRoles);
  ...
  async getAllRecipients() {
    const recipients = [];
    let index = ethers__WEBPACK_IMPORTED_MODULE_45__.BigNumber.from(0);
  ...
  async balanceOfToken(walletAddress, tokenAddress) {
    const erc20 = new ethers__WEBPACK_IMPORTED_MODULE_46__.Contract(tokenAddress, _thirdweb_dev_contracts_js_dist_abis_IERC20_json__WEBPACK_IMPORTED_MODULE_0__, this.contractWrapper.getProvider());
    ...
    return await (0,_paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.cK)(this.contractWrapper.getProvider(), tokenAddress, value);
  }
  /**
  ...
  async getRecipientSplitPercentage(address) {
    ...
    return {
      address,
      splitPercentage: walletsShares.mul(ethers__WEBPACK_IMPORTED_MODULE_45__.BigNumber.from(1e7)).div(totalShares).toNumber() / 1e5
    };
  }
  /** ******************************
   * WRITE FUNCTIONS
...
(0,_defineProperty_fe02f37c_esm_js__WEBPACK_IMPORTED_MODULE_44__._)(Split, "contractRoles", ["admin"]);
