"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_marketplace-3de0e7ea_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/marketplace-3de0e7ea.esm.js":
/*!*************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/marketplace-3de0e7ea.esm.js ***!
  \*************************************************************************/
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ethers */ "./node_modules/@ethersproject/constants/lib.esm/addresses.js");
...
/* harmony import */ var tiny_invariant__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! tiny-invariant */ "./node_modules/tiny-invariant/dist/tiny-invariant.esm.js");
...
class Marketplace {
  ...
  constructor(network, address, storage) {
    ...
    (0,_defineProperty_fe02f37c_esm_js__WEBPACK_IMPORTED_MODULE_44__._)(this, "contractWrapper", void 0);

    (0,_defineProperty_fe02f37c_esm_js__WEBPACK_IMPORTED_MODULE_44__._)(this, "storage", void 0);
    ...
    (0,_defineProperty_fe02f37c_esm_js__WEBPACK_IMPORTED_MODULE_44__._)(this, "direct", void 0);

    (0,_defineProperty_fe02f37c_esm_js__WEBPACK_IMPORTED_MODULE_44__._)(this, "auction", void 0);

    (0,_defineProperty_fe02f37c_esm_js__WEBPACK_IMPORTED_MODULE_44__._)(this, "getAll", this.getAllListings);

    this.abi = abi;
    this.contractWrapper = contractWrapper;
    this.storage = storage;
    this.metadata = new _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.ah(this.contractWrapper, _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.cq, this.storage);
    this.roles = new _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.ai(this.contractWrapper, Marketplace.contractRoles);
    ...
    this.direct = new _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.aO(this.contractWrapper, this.storage);
    this.auction = new _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.aP(this.contractWrapper, this.storage);
  ...
  async getListing(listingId) {
    ...
    if (listing.assetContract === ethers__WEBPACK_IMPORTED_MODULE_45__.AddressZero) {
      throw new _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.bh(this.getAddress(), listingId.toString());
    }

    switch (listing.listingType) {
      case _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.a$.Auction:
        {
          return await this.auction.mapListing(listing);
        }

      case _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.a$.Direct:
        {
  ...
  async getActiveListings(filter) {
    ...
    return filtered.filter(l => {
      return l.type === _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.a$.Auction && ethers__WEBPACK_IMPORTED_MODULE_46__.BigNumber.from(l.endTimeInEpochSeconds).gt(now) && ethers__WEBPACK_IMPORTED_MODULE_46__.BigNumber.from(l.startTimeInEpochSeconds).lte(now) || l.type === _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.a$.Direct && l.quantity > 0;
    });
  }
  /**
  ...
  async isRestrictedToListerRoleOnly() {
    const anyoneCanList = await this.contractWrapper.readContract.hasRole((0,_paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.bt)("lister"), ethers__WEBPACK_IMPORTED_MODULE_45__.AddressZero);
  ...
  async getOffers(listingId) {
    ...
    const offers = await Promise.all(listingEvents.map(async e => {
      const offer = await (0,_paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.cr)(this.contractWrapper.getProvider(), ethers__WEBPACK_IMPORTED_MODULE_46__.BigNumber.from(listingId), {
  ...
  async buyoutListing(listingId, quantityDesired, receiver) {
    ...
    switch (listing.listingType) {
      case _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.a$.Direct:
        {
          (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_47__["default"])(quantityDesired !== undefined, "quantityDesired is required when buying out a direct listing");
  ...
  async setBidBufferBps(bufferBps) {
    ...
    await this.contractWrapper.sendTransaction("setAuctionBuffers", [timeBuffer, ethers__WEBPACK_IMPORTED_MODULE_46__.BigNumber.from(bufferBps)]);
  }
  /**
  ...
  async setTimeBufferInSeconds(bufferInSeconds) {
    ...
    await this.contractWrapper.sendTransaction("setAuctionBuffers", [ethers__WEBPACK_IMPORTED_MODULE_46__.BigNumber.from(bufferInSeconds), bidBuffer]);
  }
  /**
  ...
  async allowListingFromSpecificAssetOnly(contractAddress) {
    ...
    if (members.includes(ethers__WEBPACK_IMPORTED_MODULE_45__.AddressZero)) {
      encoded.push(this.encoder.encode("revokeRole", [(0,_paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.bt)("asset"), ethers__WEBPACK_IMPORTED_MODULE_45__.AddressZero]));
    }

    encoded.push(this.encoder.encode("grantRole", [(0,_paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.bt)("asset"), contractAddress]));
  ...
  async allowListingFromAnyAsset() {
    ...
    for (const addr in members) {
      encoded.push(this.encoder.encode("revokeRole", [(0,_paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.bt)("asset"), addr]));
    }

    encoded.push(this.encoder.encode("grantRole", [(0,_paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.bt)("asset"), ethers__WEBPACK_IMPORTED_MODULE_45__.AddressZero]));
    await this.contractWrapper.multiCall(encoded);
  }
  /** ******************************
   * PRIVATE FUNCTIONS
  ...
  async getAllListingsNoFilter(filterInvalidListings) {
    const listings = await Promise.all(Array.from(Array((await this.contractWrapper.readContract.totalListings()).toNumber()).keys()).map(async i => {
      ...
      try {
        ...
        if (err instanceof _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.bh) {
          return undefined;
        } else {
      ...
      if (listing.type === _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.a$.Auction) {
        return listing;
      }
  ...
  applyFilter(listings, filter) {
    ...
    const start = ethers__WEBPACK_IMPORTED_MODULE_46__.BigNumber.from((filter === null || filter === void 0 ? void 0 : filter.start) || 0).toNumber();
    const count = ethers__WEBPACK_IMPORTED_MODULE_46__.BigNumber.from((filter === null || filter === void 0 ? void 0 : filter.count) || _paper_xyz_c4f1082a_esm_js__WEBPACK_IMPORTED_MODULE_43__.a_).toNumber();
...
(0,_defineProperty_fe02f37c_esm_js__WEBPACK_IMPORTED_MODULE_44__._)(Marketplace, "contractRoles", ["admin", "lister", "asset"]);
