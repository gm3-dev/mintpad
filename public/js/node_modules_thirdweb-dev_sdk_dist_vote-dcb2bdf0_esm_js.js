"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_vote-dcb2bdf0_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/vote-dcb2bdf0.esm.js":
/*!******************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/vote-dcb2bdf0.esm.js ***!
  \******************************************************************/
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ethers */ "./node_modules/@ethersproject/hash/lib.esm/id.js");
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ethers */ "./node_modules/@ethersproject/contracts/lib.esm/index.js");
...
class Vote {
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.ag(this.contractWrapper, _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cK, this.storage);
  ...
  async get(proposalId) {
    ...
    const proposals = all.filter(p => p.proposalId.eq(ethers__WEBPACK_IMPORTED_MODULE_48__.BigNumber.from(proposalId)));
  ...
  async getProposalVotes(proposalId) {
    ...
    return [{
      type: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.a$.Against,
      label: "Against",
      count: votes.againstVotes
    }, {
      type: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.a$.For,
      label: "For",
      count: votes.forVotes
    }, {
      type: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.a$.Abstain,
      label: "Abstain",
  ...
  async canExecute(proposalId) {
    ...
    const descriptionHash = ethers__WEBPACK_IMPORTED_MODULE_49__.id(proposal.description);
  ...
  async balance() {
    ...
    return {
      ...
      decimals: 18,
      value: balance,
      displayValue: ethers__WEBPACK_IMPORTED_MODULE_50__.formatUnits(balance, 18)
    };
  }
  /**
  ...
  async balanceOfToken(tokenAddress) {
    const erc20 = new ethers__WEBPACK_IMPORTED_MODULE_51__.Contract(tokenAddress, _thirdweb_dev_contracts_js_dist_abis_IERC20_json__WEBPACK_IMPORTED_MODULE_0__, this.contractWrapper.getProvider());
    return await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cH)(this.contractWrapper.getProvider(), tokenAddress, await erc20.balanceOf(this.contractWrapper.readContract.address));
  }
  /**
  ...
  async settings() {
    ...
    const votingTokenMetadata = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cr)(this.contractWrapper.getProvider(), votingTokenAddress);
    return {
