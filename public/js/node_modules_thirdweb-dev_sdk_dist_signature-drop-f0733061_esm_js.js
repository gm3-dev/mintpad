"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_signature-drop-f0733061_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/signature-drop-f0733061.esm.js":
/*!****************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/signature-drop-f0733061.esm.js ***!
  \****************************************************************************/
...
class SignatureDrop extends _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.aE {
  /**
   * @internal
   */
  ...
  constructor(network, address, storage) {
    ...
    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(this, "erc721", void 0);
    ...
    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(this, "revealer", void 0);

    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(this, "signature", void 0);

    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(this, "checkout", void 0);

    this.abi = abi;
    this.metadata = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.ag(this.contractWrapper, _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cx, this.storage);
    this.roles = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.ah(this.contractWrapper, SignatureDrop.contractRoles);
    ...
    this.erc721 = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.av(this.contractWrapper, this.storage, chainId);
    this.claimConditions = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.al(this.contractWrapper, this.metadata, this.storage);
    this.signature = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.ay(this.contractWrapper, this.storage);
    this.revealer = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.ak(this.contractWrapper, this.storage, _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cy.name, () => this.erc721.nextTokenIdToMint());
    this.signature = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.ay(this.contractWrapper, this.storage);
  ...
  async getAllClaimed(queryParams) {
    const start = ethers__WEBPACK_IMPORTED_MODULE_48__.BigNumber.from((queryParams === null || queryParams === void 0 ? void 0 : queryParams.start) || 0).toNumber();
    const count = ethers__WEBPACK_IMPORTED_MODULE_48__.BigNumber.from((queryParams === null || queryParams === void 0 ? void 0 : queryParams.count) || _QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__.D).toNumber();
  ...
  async getAllUnclaimed(queryParams) {
    const start = ethers__WEBPACK_IMPORTED_MODULE_48__.BigNumber.from((queryParams === null || queryParams === void 0 ? void 0 : queryParams.start) || 0).toNumber();
    const count = ethers__WEBPACK_IMPORTED_MODULE_48__.BigNumber.from((queryParams === null || queryParams === void 0 ? void 0 : queryParams.count) || _QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__.D).toNumber();
    const firstTokenId = ethers__WEBPACK_IMPORTED_MODULE_48__.BigNumber.from(Math.max((await this.totalClaimedSupply()).toNumber(), start));
    const maxId = ethers__WEBPACK_IMPORTED_MODULE_48__.BigNumber.from(Math.min((await this.contractWrapper.readContract.nextTokenIdToMint()).toNumber(), firstTokenId.toNumber() + count));
  ...
  async isTransferRestricted() {
    const anyoneCanTransfer = await this.contractWrapper.readContract.hasRole((0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.br)("transfer"), ethers__WEBPACK_IMPORTED_MODULE_49__.AddressZero);
...
(0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(SignatureDrop, "contractRoles", ["admin", "minter", "transfer"]);
