"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_multiwrap-33220c5a_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/multiwrap-33220c5a.esm.js":
/*!***********************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/multiwrap-33220c5a.esm.js ***!
  \***********************************************************************/
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ethers */ "./node_modules/@ethersproject/units/lib.esm/index.js");
...
class Multiwrap extends _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.aE {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
    ...
    this.abi = abi;
    this.metadata = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.ag(this.contractWrapper, _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cq, this.storage);
    this.roles = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.ah(this.contractWrapper, Multiwrap.contractRoles);
  ...
  async getWrappedContents(wrappedTokenId) {
    ...
    for (const token of wrappedTokens) {
      switch (token.tokenType) {
        case 0:
          {
            const tokenMetadata = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cr)(this.contractWrapper.getProvider(), token.assetContract);
            erc20Tokens.push({
              contractAddress: token.assetContract,
              quantity: ethers__WEBPACK_IMPORTED_MODULE_48__.formatUnits(token.totalAmount, tokenMetadata.decimals)
            });
            break;
          }
  ...
  async wrap(contents, wrappedTokenMetadata, recipientAddress) {
    const uri = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cs)(wrappedTokenMetadata, this.storage);
  ...
  async toTokenStructList(contents) {
    ...
    if (contents.erc20Tokens) {
      for (const erc20 of contents.erc20Tokens) {
        const normalizedQuantity = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.ct)(provider, erc20.quantity, erc20.contractAddress);
        const hasAllowance = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cu)(this.contractWrapper, erc20.contractAddress, normalizedQuantity);
    ...
    if (contents.erc721Tokens) {
      for (const erc721 of contents.erc721Tokens) {
        const isApproved = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cv)(this.contractWrapper.getProvider(), this.getAddress(), erc721.contractAddress, erc721.tokenId, owner);
    ...
    if (contents.erc1155Tokens) {
      for (const erc1155 of contents.erc1155Tokens) {
        const isApproved = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_46__.cv)(this.contractWrapper.getProvider(), this.getAddress(), erc1155.contractAddress, erc1155.tokenId, owner);
...
(0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_47__._)(Multiwrap, "contractRoles", ["admin", "transfer", "minter", "unwrap", "asset"]);
