"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_pack-4ed93ec1_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/pack-4ed93ec1.esm.js":
/*!******************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/pack-4ed93ec1.esm.js ***!
  \******************************************************************/
...
/* harmony import */ var _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./paper-xyz-1dc52000.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/paper-xyz-1dc52000.esm.js");
/* harmony import */ var zod__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! zod */ "./node_modules/zod/lib/index.mjs");
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ethers */ "./node_modules/@ethersproject/units/lib.esm/index.js");
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ethers */ "./node_modules/@ethersproject/bignumber/lib.esm/bignumber.js");
...
const CommonWrappableSchema = zod__WEBPACK_IMPORTED_MODULE_46__.z.object({
  contractAddress: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cB
});
/**
 * @internal
 */
...
const ERC20WrappableSchema = CommonWrappableSchema.extend({
  quantity: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cC
});
/**
 * @internal
 */
...
const ERC721WrappableSchema = CommonWrappableSchema.extend({
  tokenId: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cD
});
/**
 * @internal
 */
...
const ERC1155WrappableSchema = CommonWrappableSchema.extend({
  tokenId: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cD,
  quantity: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cD
});
...
const ERC20RewardSchema = ERC20WrappableSchema.omit({
  ...
  quantityPerReward: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cC
});
/**
 * @internal
 */
...
const ERC1155RewardSchema = ERC1155WrappableSchema.omit({
  ...
  quantityPerReward: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cD
});
/**
 * @internal
 */
...
const ERC20RewardContentsSchema = ERC20RewardSchema.extend({
  totalRewards: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cD["default"]("1")
});
/**
 * @internal
 */
...
zod__WEBPACK_IMPORTED_MODULE_46__.z.object({
  erc20Rewards: zod__WEBPACK_IMPORTED_MODULE_46__.z.array(ERC20RewardSchema).default([]),
  erc721Rewards: zod__WEBPACK_IMPORTED_MODULE_46__.z.array(ERC721RewardSchema).default([]),
  erc1155Rewards: zod__WEBPACK_IMPORTED_MODULE_46__.z.array(ERC1155RewardSchema).default([])
});
/**
 * @internal
 */

const PackRewardsOutputSchema = zod__WEBPACK_IMPORTED_MODULE_46__.z.object({
  erc20Rewards: zod__WEBPACK_IMPORTED_MODULE_46__.z.array(ERC20RewardContentsSchema).default([]),
  erc721Rewards: zod__WEBPACK_IMPORTED_MODULE_46__.z.array(ERC721RewardContentsSchema).default([]),
  erc1155Rewards: zod__WEBPACK_IMPORTED_MODULE_46__.z.array(ERC1155RewardContentsSchema).default([])
});
/**
 * @internal
 */
...
const PackMetadataInputSchema = PackRewardsOutputSchema.extend({
  packMetadata: _QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_48__.N,
  rewardsPerPack: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cD["default"]("1"),
  openStartTime: _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cE["default"](new Date())
});
/**
 * @public
 */
...
class Pack extends _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.aM {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cl(network, address, abi, options.gasless && "openzeppelin" in options.gasless ? { ...options,
      gasless: {
    ...
    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_48__._)(this, "royalties", void 0);
    ...
    (0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_48__._)(this, "owner", void 0);

    this.abi = abi;
    this.erc1155 = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.aF(this.contractWrapper, this.storage, chainId);
    this.metadata = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.ag(this.contractWrapper, _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cF, this.storage);
    this.roles = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.ah(this.contractWrapper, Pack.contractRoles);
    this.royalties = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.ai(this.contractWrapper, this.metadata);
    this.encoder = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.af(this.contractWrapper);
    this.estimator = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.aQ(this.contractWrapper);
    this.events = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.aR(this.contractWrapper);
    this.interceptor = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.aS(this.contractWrapper);
    this.owner = new _paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.aV(this.contractWrapper);
  }
  /**
   * @internal
   */
  ...
  async isTransferRestricted() {
    const anyoneCanTransfer = await this.contractWrapper.readContract.hasRole((0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.br)("transfer"), ethers__WEBPACK_IMPORTED_MODULE_49__.AddressZero);
  ...
  async getPackContents(packId) {
    ...
    for (let i = 0; i < contents.length; i++) {
      ...
      switch (reward.tokenType) {
        case 0:
          {
            const tokenMetadata = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cr)(this.contractWrapper.getProvider(), reward.assetContract);
            const rewardAmount = ethers__WEBPACK_IMPORTED_MODULE_50__.formatUnits(reward.totalAmount, tokenMetadata.decimals);
            erc20Rewards.push({
              contractAddress: reward.assetContract,
              quantityPerReward: amount.toString(),
              totalRewards: ethers__WEBPACK_IMPORTED_MODULE_51__.BigNumber.from(rewardAmount).div(amount).toString()
            });
            break;
          }
        ...
        case 2:
          {
            erc1155Rewards.push({
              ...
              tokenId: reward.tokenId.toString(),
              quantityPerReward: amount.toString(),
              totalRewards: ethers__WEBPACK_IMPORTED_MODULE_51__.BigNumber.from(reward.totalAmount).div(amount).toString()
            });
            break;
          }
      }
  ...
  async createTo(to, metadataWithRewards) {
    const uri = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cs)(metadataWithRewards.packMetadata, this.storage);
        ...
        case 0:
          {
            ...
            erc20Rewards.push({
              contractAddress: reward.assetContract,
              quantityPerReward: ethers__WEBPACK_IMPORTED_MODULE_50__.formatUnits(reward.totalAmount, tokenMetadata.decimals).toString()
            });
            break;
          }
  ...
  async toPackContentArgs(metadataWithRewards) {
    ...
    for (const erc20 of erc20Rewards) {
      const normalizedQuantity = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.ct)(provider, erc20.quantityPerReward, erc20.contractAddress); // Multiply the quantity of one reward by the number of rewards

      const totalQuantity = normalizedQuantity.mul(erc20.totalRewards);
      const hasAllowance = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cu)(this.contractWrapper, erc20.contractAddress, totalQuantity);
    ...
    for (const erc721 of erc721Rewards) {
      const isApproved = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cv)(this.contractWrapper.getProvider(), this.getAddress(), erc721.contractAddress, erc721.tokenId, owner);
    ...
    for (const erc1155 of erc1155Rewards) {
      const isApproved = await (0,_paper_xyz_1dc52000_esm_js__WEBPACK_IMPORTED_MODULE_47__.cv)(this.contractWrapper.getProvider(), this.getAddress(), erc1155.contractAddress, erc1155.tokenId, owner);
      ...
      contents.push({
        ...
        tokenType: 2,
        totalAmount: ethers__WEBPACK_IMPORTED_MODULE_51__.BigNumber.from(erc1155.quantityPerReward).mul(ethers__WEBPACK_IMPORTED_MODULE_51__.BigNumber.from(erc1155.totalRewards)),
...
(0,_QueryParams_24720dd7_esm_js__WEBPACK_IMPORTED_MODULE_48__._)(Pack, "contractRoles", ["admin", "minter", "asset", "transfer"]);
